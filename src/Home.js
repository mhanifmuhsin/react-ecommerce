...
const Home = () => {
    ...
    const [productPreview, setProducPreview] = useState([]);
    const initialState = [];
    const [carts, setCart] = useState([]);
    const findById = (id) => {
        setProducPreview(products.filter(product => product.id === id));
    }
        ...
        <>
            ...
            <div className='container'>
                <div className='flex row'>
                    ...
                    {/* modal detail */}
                    <div className="modal fade" id="detail" tabIndex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div className="modal fade" id="payment" tabIndex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered" role="document">
                            <div className="modal-content">
                                <div className="modal-header">
